...
local MINOR_VERSION = 90000 + tonumber(("$Revision: 119 $"):match("(%d+)"))
...
--		fishing_min = 330,
	...
	zones[BZ["Wailing Caverns"]] = {
		...
		type = "Instance",
		fishing_min = 75,
		entrancePortal = { BZ["Northern Barrens"], 52.40, 55.20 },  -- TODO: check
	}
	...
	zones[BZ["Razorfen Kraul"]] = {
		...
		groupSize = 5,
		type = "Instance",
		entrancePortal = { BZ["Southern Barrens"], 40.6, 89.6 },  -- TODO: check
	}
	...
	zones[BZ["Razorfen Downs"]] = {
		...
		groupSize = 5,
		type = "Instance",
		entrancePortal = { BZ["Southern Barrens"], 47, 88.1 }, -- TODO: check
	}
	...
	zones[BZ["Vault of Archavon"]] = {
		...
		altGroupSize = 25,
		type = "Instance",
--		entrancePortal = { BZ["Wintergrasp"], 58, 45 }, -- TODO: coordinates
	}
...
--	Cataclysm Battlegrounds
	...
	zones[BZ["The Lost Isles"]].texture = "LostIsles"
